...
export type Trust = z.infer<typeof trust_schema>;
...
// Trust Account Testing Structure
const trust_external_id = Math.random().toString(36).substring(2, 12)
const trust_prefix = `trusts`
const trust_email = `${Math.random().toString(36).substring(2, 8)}@gmail.com`

console.log('Trust Account Testing Data:')
console.log('Trust External ID:', trust_external_id)
console.log('Trust Email:', trust_email)
console.log('Trust Prefix:', trust_prefix)

export const trustApplication: Application = {
    customer: {
        trust: {
            identification: [
                {
                    ...
                    name: "Family Trust",
                    typeOfTrust: "IRREVOC",
                    purposeOfTrust: "Investment Management",
                    dateFormed: "2020-01-01",
                    formationCountry: "CRI",
                    formationState: "CR-SJ",
                    registrationNumber: trust_external_id,
                    registrationType: "SSN",
                    registrationCountry: "CRI",
                    sameMailAddress: true,
                },
            ],
            financialInformation: [
                ...
                individual: [
                    {
                        ...
                        employmentDetails: {
                            employerBusiness: "Education",
                            employer: "Universidad de Costa Rica",
                            occupation: "Student",
                            employerAddress: {
                                country: "CRI",
                                street1: "Ciudad Universitaria",
                                street2: "",
                                city: "San Jose",
                                state: "CR-SJ",
                                postalCode: "11501",
                ...
                individuals: [
                    {
                        ...
                        identification: {
                            passport: "112233445",
                            issuingCountry: "CRI",
                            expirationDate: "2034-02-20",
                            citizenship: "CRI",
                        },
                        employmentType: "EMPLOYED",
                        employmentDetails: {
                            employerBusiness: "Legal",
                            employer: "Gonzalez Law",
                            occupation: "Lawyer",
                            employerAddress: {
                                country: "CRI",
                                street1: "Law St",
    ...
    users: [
        {
            externalUserId: trust_external_id,
            externalIndividualId: trust_external_id,
            prefix: trust_prefix,
        },
    ],
    documents: [],
