  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6">
        ...
        <BankingStepsCard title={copy.stepsTitle} intro={copy.stepsIntro} steps={copy.steps} />
        <BankingStepsCard title={copy.wireTitle} intro={copy.wireIntro} steps={copy.wireSteps} />
        <BankingStepsCard title={copy.achTitle} intro={copy.achIntro} steps={copy.achSteps} />
      </div>
    </motion.div>
  )
}
